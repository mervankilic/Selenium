...
public class C06_ByIdLocator {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // arama kutusuna phone yazıd arattırın
        ...
        // Webelementler direk yazdırılamaz
        // Eger webelement uzerindeki yazıyı elde etmek istersek
        ...
        if (sonucSayisiInt > 0) {
            ...
            System.out.println("Arama testi FAIELD");
        }
