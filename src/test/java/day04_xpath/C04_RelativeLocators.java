...
public class C04_RelativeLocators {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // DSLR Camera elementi locate edin

        WebElement dslrCameraElementi = driver.findElement(By.id("pic7_thumb"));

        // webelementin HTML kodunda src tag'inin
        ...
        /*
           Bir websayfasinda
           bir webelementi gorebiliyor, HTML kodlarına ulasabiliyor
           ama locate edemiyorsaniz

           etrafindaki webelemenetleri kullanarak,
           locate islemini yapabilmemiz icin
           Selenium4 ile birlikte relative locator ozelligi gelmistir

           Relative locator icin
           - hedef elementin en az 1 ozeligi
           - hedef elementin etrafinda locate edip kullanabildigimiz en aaz 1 baska webelement
           olmalidir
         */


        // DLSR camera webelementi ve relative locator kullanarak
        ...
        // Motor E13 telefonunun src attribute'inda 16882639136208024 numarasinin bulundugunu test edin
